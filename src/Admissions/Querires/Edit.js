...
export default class EditInquery extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/Qurries/update/' + this.props.match.params.id, query)
      .then(res => console.log(res.data));

      window.location = '/Admission/Queries/View/' + this.props.match.params.id;
              ...
              <div className="row">
                ...
                <div className="col-6 form-group">
                  <label className="sec-1">
                      ...
                      <input className="form-control" type="text"   placeholder="03331234567"
              ...
              <div className="row">
                <div className="col-12 form-group">
                  <label className="sec-1">
                      ...
                      <input className="btn btn-primary" type="submit" value="Update Query"  placeholder="Username" />
                    </label>
                  </div>
              </div>
            </form>
